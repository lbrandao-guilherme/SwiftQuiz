...
//    Variable quizes is a Array of Tuples
    private let quizes: [(question: String, correctAnswer: String, options: [String])] = [
            ...
            (question: "Qual é o tipo de uma variável String que pode aceitar nil?", correctAnswer: "String?",
...
//    Variavel computada para leitura
    var question: String {
